...
class ASTORE_0Test {
    ...
    void execute() {
        ...
        final Consumer<JvmThread> beforeASTORE_0ExecuteListener = jvmThread -> {
        ...
        final Consumer<JvmThread> afterASTORE_0ExecuteListener = jvmThread -> {
        ...
        jvmThreadRunner.addBeforeInstructionExecutionListener(
                ASTORE_0.class,
                beforeASTORE_0ExecuteListener
        );

        jvmThreadRunner.addAfterInstructionExecutionListener(
                ASTORE_0.class,
                afterASTORE_0ExecuteListener
        );
